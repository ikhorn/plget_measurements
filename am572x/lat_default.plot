...
\nDriver: min = `sed -n '/min\ val/s/\(^.*\)= \(.\)/\2/p' "@file_name" | sed -n '3p'`, \
...
with points pointtype 3 lc rgb "blue" title "driver tx latency (packet scheduler entrance -> wire) , us"
