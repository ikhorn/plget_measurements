...
file_name = 'am572_hwts_noCBS_noCPDMA_classA_parB_1000.data'
file_name2 = 'am572_hwts_noCBS_noCPDMA_classB_parA_1000.data'
...
set terminal qt 0
plot[44659:46659] "< sed -e '0,/----/ d' -e '/----/,$ d' -n -e '/[0-9]/s/$/ 516/p' ". file_name \
...
set terminal qt 4
plot[44659:1.07185e+06] "< sed -e '0,/----/ d' -e '/----/,$ d' -n -e '/[0-9]/s/$/ 516/p' ". file_name \
with points pointtype 7 black title "Class A packet", \
"< sed -e '0,/----/ d' -e '/----/,$ d' -n -e '/[0-9]/s/$/ 516/p' ". file_name2 \
with points pointtype 7 lc rgb "red" title "Class B packet"
